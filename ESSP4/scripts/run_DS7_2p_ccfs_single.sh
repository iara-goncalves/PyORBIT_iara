...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_single/Output_DS7_2p_ccfs_single.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_single/DS7/DS7_2p/DS7_2p_ccfs

# Clean up previous runs
rm -f configuration_file_emcee_run_DS7_2p_ccfs_single.log
...
pyorbit_run emcee DS7_2p_ccfs.yaml > configuration_file_emcee_run_DS7_2p_ccfs_single.log
...
echo "Job DS7_2p_ccfs_single completed at: $(date)"
