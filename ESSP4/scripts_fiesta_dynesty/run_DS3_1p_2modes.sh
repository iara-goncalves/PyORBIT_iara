...
#BSUB -o ../out_fiesta_dynesty/Output_DS3_1p_2modes.out

# Change to configuration directory
cd ../results_fiesta_dynesty/DS3/DS3_1p_2modes
...
pyorbit_run dynesty DS3_1p_2modes.yaml > configuration_file_emcee_run_DS3_1p_2modes.log
pyorbit_results dynesty DS3_1p_2modes.yaml -all >> configuration_file_emcee_run_DS3_1p_2modes.log
