...
#BSUB -o ../out_fiesta_dynesty/Output_DS8_3p_3modes.out

# Change to configuration directory
cd ../results_fiesta_dynesty/DS8/DS8_3p_3modes
...
pyorbit_run dynesty DS8_3p_3modes.yaml > configuration_file_emcee_run_DS8_3p_3modes.log
pyorbit_results dynesty DS8_3p_3modes.yaml -all >> configuration_file_emcee_run_DS8_3p_3modes.log
...
echo "Job DS8_3p_3modes completed at: $(date)"
