...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS3_2p_ccfs.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS3/DS3_2p/DS3_2p_ccfs
...
pyorbit_run dynesty DS3_2p_ccfs.yaml > configuration_file_emcee_run_DS3_2p_ccfs.log
pyorbit_results dynesty DS3_2p_ccfs.yaml -all >> configuration_file_emcee_run_DS3_2p_ccfs.log
