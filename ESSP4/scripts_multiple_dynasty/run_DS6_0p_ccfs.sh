...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS6_0p_ccfs.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS6/DS6_0p/DS6_0p_ccfs
...
pyorbit_run dynesty DS6_0p_ccfs.yaml > configuration_file_emcee_run_DS6_0p_ccfs.log
