...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS1_2p_4_activity_indi.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS1/DS1_2p/DS1_2p_4_activity_indi
...
pyorbit_run dynesty DS1_2p_4_activity_indi.yaml > configuration_file_emcee_run_DS1_2p_4_activity_indi.log
pyorbit_results dynesty DS1_2p_4_activity_indi.yaml -all >> configuration_file_emcee_run_DS1_2p_4_activity_indi.log
