...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS3_0p_5_activity_indi.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS3/DS3_0p/DS3_0p_5_activity_indi
...
pyorbit_run dynesty DS3_0p_5_activity_indi.yaml > configuration_file_emcee_run_DS3_0p_5_activity_indi.log
