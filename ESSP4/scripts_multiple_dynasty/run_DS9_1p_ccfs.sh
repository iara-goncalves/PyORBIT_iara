...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple_dynasty/Output_DS9_1p_ccfs.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple_dynasty/DS9/DS9_1p/DS9_1p_ccfs
...
pyorbit_run dynesty DS9_1p_ccfs.yaml > configuration_file_emcee_run_DS9_1p_ccfs.log
