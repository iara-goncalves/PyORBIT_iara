"""
PyORBIT CSV Export for ESSP Submission - FIESTA emcee Configurations
...
# Base directories
base_results_dir = '/work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_fiesta_emcee'
output_base_dir = '/work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/submission_csv_files/results_fiesta_emcee'
best_models_csv = '/work2/lbuc/jzhao/PyORBIT_ESSP/post_analysis/results_fiesta_emcee.csv'
...
print("="*80)
print("PROCESSING BEST FIESTA EMCEE MODELS")
print("="*80)
...
for idx, row in best_models_df.iterrows():
    ...
    # Example: /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_fiesta_emcee_1026/DS1/DS1_1p_2modes
    ...
    # Build paths - the structure is DS2/DS2_3p_3modes/DS2_3p_3modes/emcee_plot/model_files
    config_dir = os.path.join(base_results_dir, dataset_name, config_name)
    model_files_dir = os.path.join(config_dir, config_name, 'emcee_plot', 'model_files')
    ...
    try:
        ...
        # CSV NAMING FORMAT (WITHOUT planet config): DS1_DTU-Padova-PSU_emcee_2modes_results.csv
    ...
    if os.path.exists(log_file):
        ...
        if hyperparams:
            ...
            if config_hyperparams:
                ...
                # CSV NAMING FORMAT (WITHOUT planet config): DS1_DTU-Padova-PSU_emcee_2modes_hyperparameters.csv
...
print("\n" + "="*80)
print("ALL BEST FIESTA EMCEE MODELS PROCESSED!")
print("="*80)
