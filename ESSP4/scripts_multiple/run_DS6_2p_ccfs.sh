...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple/Output_DS6_2p_ccfs.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple/DS6/DS6_2p/DS6_2p_ccfs
...
pyorbit_run emcee DS6_2p_ccfs.yaml > configuration_file_emcee_run_DS6_2p_ccfs.log
pyorbit_results emcee DS6_2p_ccfs.yaml -all >> configuration_file_emcee_run_DS6_2p_ccfs.log
