...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_multiple/Output_DS2_0p_4_activity_indi.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_multiple/DS2/DS2_0p/DS2_0p_4_activity_indi
...
pyorbit_run emcee DS2_0p_4_activity_indi.yaml > configuration_file_emcee_run_DS2_0p_4_activity_indi.log
pyorbit_results emcee DS2_0p_4_activity_indi.yaml -all >> configuration_file_emcee_run_DS2_0p_4_activity_indi.log
