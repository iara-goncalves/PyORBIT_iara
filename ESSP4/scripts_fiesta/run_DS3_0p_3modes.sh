...
#BSUB -o /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/out_fiesta/Output_DS3_0p_3modes.out

# Change to configuration directory
cd /work2/lbuc/iara/GitHub/PyORBIT_examples/ESSP4/results_fiesta_emcee_kostas/DS3/DS3_0p_3modes
...
pyorbit_run emcee DS3_0p_3modes.yaml > configuration_file_emcee_run_DS3_0p_3modes.log
pyorbit_results emcee DS3_0p_3modes.yaml -all >> configuration_file_emcee_run_DS3_0p_3modes.log
